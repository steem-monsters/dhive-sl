// import fs from 'fs';
// import { log, tryParse } from '../utils-sl';
...
// export interface HiveEngineParameters {
//     rpcUrl?: HiveEngineOptions['rpcUrl'];
//     chainId?: HiveEngineOptions['chainId'];
//     saveState?: HiveEngineOptions['saveState'];
//     loadState?: HiveEngineOptions['loadState'];
//     stateFile?: HiveEngineOptions['stateFile'];
//     onOp?: HiveEngineOptions['onOp'];
// }
...
//             let state = JSON.parse(fs.readFileSync(String(this.options.stateFile)).toString());
